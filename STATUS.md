...
- Migrations `001` through `031` are the canonical migration chain, despite a few duplicated numeric prefixes in filenames.
...
- Migrations through `031` are now the expected app chain.
...
- `docs/MIGRATIONS.md` — policy for the logical 001–031 chain and duplicate numeric prefixes
