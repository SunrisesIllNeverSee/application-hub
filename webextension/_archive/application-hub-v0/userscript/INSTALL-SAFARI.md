...
3. Go to **applicationhub.app → Profile → Settings** → scroll to **"Appfeeder Extension"**
4. Click **"Show session token"** → **"Copy"**
5. Paste it into the panel and click **Connect** — your answer bank loads immediately
