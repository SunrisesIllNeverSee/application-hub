...
(function () {
  ...
  const SUPABASE_ANON_KEY = 'sb_publishable_xUCxfK8BTjptVdsXGIBkNQ_I9Mnh-bo';
  ...
  function renderSetupPanel() {
    ...
    label.textContent = 'Paste your Application Hub access token. Get it from: Profile → Settings → scroll to "Appfeeder Extension" → Show session token → Copy';
