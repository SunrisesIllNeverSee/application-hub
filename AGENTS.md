# Application Hub — Codex Context

> This file is the persistent context for any Codex or Cowork session working on this project.
...
MCP Server (TypeScript)            ← intelligence layer, 16 tools
  ↕
Codex Desktop / Cursor / Windsurf ← AI drafting interface (current)
  ↕
...
Connect to Codex Desktop — add to `~/Library/Application Support/Codex/claude_desktop_config.json`:
