# Y Combinator — Summer 2026 — Submitted Application

**Status:** Submitted  
**Date:** 2026-05-26  
**Batch:** Summer 2026  
**Source:** Exported from YC application portal (`yc_submitted.md`)
...
**Twitter:** https://x.com/burnmydays  
...
**Education:**  
University at Buffalo — Bachelor's, History Sociology (Dec 2008 – Dec 2010)  
University of Hawaii at Hilo — BA, History Sociology (Dec 2006 – Jan 2007)  
SUNY Geneseo — BA, History Sociology (Dec 2004 – Jan 2009)  
Erie Community College — Associates, Liberal Arts (Jan 2002 – Jan 2005)  

**Work Experience:**  
Invisible Children Inc. — Roadie (Jan 2009 – May 2009)  
Deric J. McHenry Painting, Inc. — Owner (Jan 2003 – Jul 2020)  

---

## Accomplishments

**Most successfully hacked a non-computer system:**  
There is so many. One of my favorites though is when i was doing a summer session in Athens, Greece. On our final exam, i found the essay questions did not properly represent class. So, i crossed out the questions wrote new ones and then answered them.

**Most impressive thing other than this startup:**  
24 years sober, active in community specific to young people struggling with mental health and substance abuse. Participated and Hosted Local, Regional, National, and International Events and Conferences. Invisible Children 2009 Rescue. Founded Construction Company Renovating and Restoration of Historical Homes Specializing in Exterior Painting.

**Things built before:**  
Before this nothing technical. Everything dealt with interior and exterior painting and restoration.

**Competitions / awards / papers:**  
Several local community awards. Commitment Theory https://zenodo.org/records/20031715 — Conservation Law of Commitment https://zenodo.org/records/20029607
...
Language based governance for AI systems.

**URL:** mos2es.com  
**Product link:** signomy.xyz  
...
**Where:** Buffalo, NY now / NYC or California post-YC  

**Why:** Family is in Buffalo. NYC needs some help growing. Also close with Toronto. Appreciate more visits to California though. Been awhile since my time with Invisible Children.
...
**How far along:**  
Pre-seed at the protocol-substrate stage, the signals that matter look different:

4 U.S. patent filings + MO§ES™ trademark — compression substrate, signal compression engine, civic infrastructure, conservation law, master architecture. Filed Sept 2025 – Feb 2026.
...
**Are people using it:** No — agents have tested, still working out bugs.  
**Revenue:** No  
...
**Same idea as previous batch / pivot:**  
I am not sure if I applied before or not.

**Prior incubators / accelerators:** N/A
...
Signomy (live): agent marketplace, 270 API endpoints, Stripe Connect. Earns on every governed transaction that clears the constitutional layer.

AQUA (live): founder-first application OS. Freemium SaaS — free tier, Pro ($19/mo), Team ($49/mo).

SigRank / Leaderboard (shipping): operator-based AI performance index — video-game-style stats, ranks, and insights for AI users. Consumer product built on the SIGSYSTEM measurement substrate.

KASSA (live): voice-AI commitment-kernel demo. Eliminates NLU re-inference per call (50s → 6.5s). Licensable as a voice infrastructure primitive.
...
MO§ES™ is a sovereign entity. Its clones, products, and surfaces are each available for acquisition, white-label deployment, and licensing independently.

Long-term compounding unit: every passing trace becomes a Vault Artifact — cryptographically signed, lineage-bound, tradable as digital property. One OTel span = audit + contract + payment obligation simultaneously.
...
**Legal entity:** LLC on path towards S-Corp  
**Equity breakdown:** 100% owner  
**Investment taken:** No  
**Currently fundraising:** Yes — just starting  

---

## Curious

**What convinced you to apply / YC events:**  
Conversation had at the Pitch by Deel in NYC.

**How did you hear about YC:** X

**Batch preference:** Current (Summer 2026)
