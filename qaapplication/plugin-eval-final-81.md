...
- deferred_cost_tokens: 72382 (excessive)
- total_tokens: 73514 (excessive)
...
- [FAIL] deferred_cost_tokens-budget-high: deferred_cost_tokens is excessive relative to the current Codex baseline. Evidence: Value: 72382 tokens Baseline samples: skills=24, plugins=116 Remediation: Reduce repeated instruction text and move detail into deferred supporting files.
- [WARN] ts-complexity-high: At least one TypeScript function has high cyclomatic complexity. Evidence: Max complexity: 49 Remediation: Split complex functions into smaller branches with clearer responsibilities.
...
- deferred_cost_tokens: 72382 tokens (excessive)
- ts_file_count: 40 files (good)
- ts_function_count: 44 functions (good)
- ts_max_cyclomatic_complexity: 49 score (heavy)
- ts_average_function_length: 37.59 lines (moderate)
- ts_max_nesting_depth: 6 levels (heavy)
- ts_comment_ratio: 0.022 ratio (moderate)
